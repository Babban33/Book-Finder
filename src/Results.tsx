...
function Results({ searchResults }: ResultsProps) {
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
    <div className="bg-white w-11/12 lg:w-3/4 p-6 rounded-lg shadow-lg relative max-h-[80vh] flex flex-col lg:flex-row">
      ...
      <div className="lg:flex-grow lg:w-2/3 lg:pl-6 overflow-y-auto space-y-4">
        <h4 className="text-3xl lg:text-5xl font-bold text-gray-800 mb-4">{selectedBook.title}</h4>

        {/* Author Section */}
        <div className="text-gray-700">
          <h5 className="font-semibold text-lg mb-1">Author(s)</h5>
        ...
        {/* Publisher Section */}
        <div className="text-gray-700">
          <h5 className="font-semibold text-lg mb-1">Publisher(s)</h5>
          <p className="text-gray-600 mb-2">
        ...
        {/* ISBN Section */}
        <div className="text-gray-700">
          <h5 className="font-semibold text-lg mb-1">ISBN(s)</h5>
